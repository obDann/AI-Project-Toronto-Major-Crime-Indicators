...
non_agg_df %>%
   ...
   select(EVENT_UNIQUE_ID, OCC_YEAR, OCC_MONTH, OCC_DAY, OCC_HOUR, OCC_DOY, OCC_DOW,
...
```{r}
sqldf("
      SELECT OCC_YEAR, OCC_MONTH, OCC_DAY, OCC_HOUR, OCC_DOY, OCC_DOW,
      DIVISION, PREMISES_TYPE, UCR_CODE_CATEGORY, OFFENCE_REWORK,
      NEIGHBOURHOOD_158, IS_HOLIDAY, HOLIDAY_DESCRIPTION, DOW_SIMPLE,
      MCI_CATEGORY, COUNT(DISTINCT EVENT_UNIQUE_ID) NUM_CRIMES
      FROM to_aggregate
      GROUP BY OCC_YEAR, OCC_MONTH, OCC_DAY, OCC_HOUR, OCC_DOY, OCC_DOW,
      DIVISION, PREMISES_TYPE, UCR_CODE_CATEGORY, OFFENCE_REWORK,
      NEIGHBOURHOOD_158, IS_HOLIDAY, HOLIDAY_DESCRIPTION, DOW_SIMPLE,
      MCI_CATEGORY
      ") %>% 
